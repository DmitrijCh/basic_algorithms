/* Принцип работы алгоритма:
 ...
 Сортировка quick sort состоит из выбора элемента для сравнения(pivot),сравнения всех элементов с pivot и отнесения
элемента в правую или левую часть в массиве. Дополнительные еструктуры данных не используются для перекладывания элементов
