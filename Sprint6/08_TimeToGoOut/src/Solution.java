...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        inputDirectedGraph();
        int startVertex = 1;
        System.out.println(DFSSaithTime(startVertex, vertexQuantity, adjacentMap));
    }
    ...
    public static String DFSSaithTime(int startVertex, int vertexesQuantity, HashMap<Integer, ArrayList<Integer>> adjacentMap) {
