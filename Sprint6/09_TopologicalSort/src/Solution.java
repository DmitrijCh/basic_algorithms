...
public class Solution {
    ...
    public static List<Integer> topologicalOrder = new ArrayList<>();
    public static int vertexQuantity;
    public static int edgeQuantity;

    public static void main(String[] args) throws IOException {
        inputDirectedGraph();
        System.out.println(topologicalSortMain(vertexQuantity, (HashMap<Integer, ArrayList<Integer>>) adjacentMap));
    }
    ...
    public static String topologicalSortMain(int vertexesQuantity, HashMap<Integer, ArrayList<Integer>> adjacentMap) {
        ...
        for (int i = topologicalOrder.size() - 1; i >= 0; i--) {
            stringBuilder.append(topologicalOrder.get(i)).append(" ");
        }
