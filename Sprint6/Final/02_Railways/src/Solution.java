/* Принцип работы алгоритма:
 На вход подается строка с типом железной дороги из города i в город i + j + 1. Из города i в город i + j + 1 можно
добраться как по дорогам типа R, так и по дорогам типа B. Переведя в графы задачу можно представить в виде вершин -
городов и ребер - железных дорог.
 Возьмем пример из трех городов. В котором из первого город можно добраться в город 2 с помощью дороги типа В, а в
город 3 с помощью дороги типа R. Из второго города можно добраться в город 3 с помощью дороги типа В.
...
определить имеются ли в нем циклы или нет.
 Чтобы трансформировать входные данные в граф выберем для железной дороги типа B направление ребра из города i в город
i + j + 1, а для типа R наоборот.
...
public class Solution {
    ...
    public static List<List<Integer>> adjacentList = new ArrayList<>();
    ...
    private static void loopInGraph() {
        if (findLoop()) {
